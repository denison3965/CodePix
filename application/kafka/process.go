...
import (
	...
	appmodel "github.com/denison3965/CodePix/application/model"
	"github.com/denison3965/CodePix/application/usecase"
	"github.com/denison3965/CodePix/domain/model"

	"github.com/denison3965/CodePix/application/factory"
)
...
func (k *KafkaProcessor) processMessage(msg *ckafka.Message) {
	...
	transactionConfimationTopic := "trasaction_confirmation"

	switch topic := *msg.TopicPartition.Topic; topic {
	case transactionsTopic:
		k.processTransaction(msg)
	case transactionConfimationTopic:
